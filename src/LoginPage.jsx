...
import { Box, Button, Input, FormControl, FormLabel, Heading, Image, Text } from '@chakra-ui/react'; // Removed unused import
...
>
    ...
    <Box className="login-container" p={4} display="flex" justifyContent="center" alignItems="center" height="80vh" mt={40}>
      <Box maxW="md" borderWidth="1px" borderRadius="lg" py={6} boxShadow="xl" position="relative" zIndex="1">
        ...
        <Link to={"/doctor"}>
        <Text color="gray.500" opacity="0.7" fontWeight="bold" fontSize="lg">Doctor Login</Text>
        </Link>
      </Box>
    </Box>
  </>
